package cn.happymaya.ddp.support.dao.impl.factory;

import cn.happymaya.ddp.support.exception.DaoException;
...
/**
 * The factory that get to configure of the value objects.
 * @author superhsc
 */
@Component
public class VObjFactory extends XmlBuildFactoryTemplate {
	...
	/**
	 * get to configure of the certain value object.
	 * @param clazz the class name of the value object
	 * @return to configure of the value object
	 */
	...
	/**
	 * load all the child nodes into vObj.
	 * @param element element
	 * @param vObj vObj
	 */
