...
import cn.happymaya.ddp.support.exception.OrmException;
...
public class BeanUtils {
	...
	public static Method getMethodIfExists(Object service, String methodName) {
		...
		return rtn; // if you have overridden, return the last one.
	}
	...
	public static Method getMethod(Object service, String methodName) {
		...
		if(rtn!=null) return rtn; // if you have overridden, return the last one.
